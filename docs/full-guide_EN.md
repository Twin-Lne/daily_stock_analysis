...
> It does not close Issue #1497 in this PR; runtime behavior is unchanged and must be implemented in a separate change set.
...
> This note is for scope clarification only; Issue #1497 remains open until a runtime implementation PR is merged.
